...
Use fictional records in the local demo and any public demonstration. Anyone accessing the local demo can select its demo accounts. Do not upload sensitive financial files to a public demo deployment. AWS/Cognito/SQS deployment and genuine Bedrock inference remain unverified; a cPanel frontend package alone is a static preview.
