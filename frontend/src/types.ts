...
export type Grant = { id: string; name: string; funderName: string; funderOrgId: string; granteeOrgId: string; currency: string; awardMinor: number; allocatedMinor: number; fundingMode: string; deadline: string; template: string; version: number; readiness: Readiness }
...
export type Allocation = { grantId: string; amountMinor: number }
export type Expense = { id: string; description: string; amountMinor: number; currency: string; date: string; allocations: Allocation[]; paid?: boolean }
