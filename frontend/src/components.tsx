...
export const date = (value?: string | null) => value ? new Intl.DateTimeFormat('en-GB', { day: 'numeric', month: 'short', year: 'numeric', timeZone: 'Europe/Bucharest' }).format(new Date(value.length === 10 ? `${value}T12:00:00Z` : value)) : 'Not provided'
